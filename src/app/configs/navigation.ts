...
export const NAVIGATION_CONFIG: NavigationSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        route: 'display',
        keywords: ['block', 'inline', 'inline-block', 'none', 'visibility', 'hidden', 'базовый'],
      },
      {
        id: '1.5',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'CSS Grid',
        route: 'grid',
        keywords: ['grid', 'template', 'repeat', 'minmax', 'gap', 'сетка', 'колонки', 'строки'],
      },
      {
        id: '2.4',
  ...
  {
    title: 'Блок 6: Адаптивность и функции',
    items: [
      {
        id: '6.1',
